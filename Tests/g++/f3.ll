...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_f3.cpp, i8* null }]
...
define i32 @main() #2 {
  ...
  %3 = call i32 @_ZN1B1gEii(%class.B* %2, i32 1, i32 2)
  ret i32 0
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr i32 @_ZN1B1gEii(%class.B*, i32, i32) #1 comdat align 2 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_f3.cpp() #0 section ".text.startup" {
